...
Status: **Proposed release contract; Gate 3 passed for the exact engineering candidate**

## Current checkpoint truth

This document defines the evidence a future release must produce. Gate 2 was founder-approved on 2026-07-11 at exact revision [`e53f399`](../project/gate-2-approval.md). Gate 3 passed on 2026-07-14 at exact engineering candidate [`4adf1fb500b651e425735595db528fd42fffba73`](../project/gate-3-evidence.md). Gate 4 sprint planning is authorized, but no runtime inventory exists and Gate 4 behavior remains gated on founder acceptance of its proposed sprint brief. This document does not claim an installable artifact, public release version, signing identity, publication namespace, accepted security review, SBOM, or accepted package lifecycle.
...
Gate 3 work started after the explicit Gate 2 disposition and passed for the exact engineering candidate recorded in the [Gate 3 evidence ledger](../project/gate-3-evidence.md). Implemented contributor commands are supported only where [Development setup](../operations/development-setup.md) records successful evidence. The pass authorizes Gate 4 sprint planning only; Gate 4 behavior and all public-release activity remain blocked by their owning gates.
